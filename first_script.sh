...
# $? $* $#
# 0 - успешное выполнение команды    touch newfile ; echo $?    test a = a ; echo $?  test a != b ; echo $?
#1 - ошибка     grep aaa newfile ; echo $?      test a = b : echo $?
#2 - ошибка использования встроенных команд шелла      kill ; echo $?
#3-126 -команда, которую мы вызвали не может быть исполнена  ./newfile ; echo $?
#127 - команда не найдена     asdasdasdaasdas ; echo $?
